...
export class LangChainInstrumentation extends InstrumentationBase {
    constructor({ instrumentationConfig, traceConfig, } = {}) {
        super("@arizeai/openinference-instrumentation-langchain", VERSION, Object.assign({}, instrumentationConfig));
    ...
    init() {
        const module = new InstrumentationNodeModuleDefinition("@langchain/core/dist/callbacks/manager.cjs", ["^0.1.0", "^0.2.0"], this.patch.bind(this), this.unpatch.bind(this));
        return module;
    }
        ...
        if ("_configureSync" in module.CallbackManager) {
            ...
            this._wrap(module.CallbackManager, "configure", (original) => {
                return function (...args) {
                    ...
                    const newHandlers = addTracerToHandlers(instrumentation.oiTracer, handlers);
                    args[0] = newHandlers;
                    return original.apply(this, args);
                };
            });
