...
class Agent_Agentflow {
     ...
     */
    prepareOutputObject(response, availableTools, finalResponse, startTime, endTime, timeDelta, usedTools, sourceDocuments, artifacts, additionalTokens = 0, isWaitingForHumanInput = false) {
        const output = {
            content: finalResponse,
            timeMetadata: {
                start: startTime,
